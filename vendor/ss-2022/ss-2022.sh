...
MAINLAND_BLOCK_REPO_URL="https://raw.githubusercontent.com/by44vfg7pv-rgb/snell.sh/main/vendor/ss-2022/block-mainland.sh"
MAINLAND_EXTRACT_REPO_URL="https://raw.githubusercontent.com/by44vfg7pv-rgb/snell.sh/main/vendor/ss-2022/extract-cn-ip-from-mmdb.py"
...
Install() {
    ...
    curl -L -s https://raw.githubusercontent.com/by44vfg7pv-rgb/snell.sh/main/vendor/ss-2022/ss-2022.sh -o "/usr/local/bin/ss-2022.sh"
...
Update_Shell() {
    ...
    if ! wget --no-check-certificate -O ${temp_file} "https://raw.githubusercontent.com/by44vfg7pv-rgb/snell.sh/main/vendor/ss-2022/ss-2022.sh"; then
...
install_shadowtls() {
    ...
    # 下载 ShadowTLS 脚本
    wget -N --no-check-certificate https://raw.githubusercontent.com/by44vfg7pv-rgb/snell.sh/main/vendor/ss-2022/shadowtls.sh
